...
class CoSADUV_NoTemporal(nn.Module):
    ...
    def forward(self, x):
        ...
        # Softmax scoring - project each pixel's value into probability space (0, 1), with sum of all pixels = 1
        output_score = self.score(output_upsampled.contiguous().view(N, 1, -1))
