...
def convert_SALICON_Data(input_directory='C:/Users/simon/Downloads/Project Datasets/SALICON',
    ...
    for image_file in tqdm(file_names):
        ...
        if image_file.endswith('.jpg') and 'train' in image_file:
            # read the image
    ...
    count = 0
    for image_file in tqdm(file_names):
        # Check that the file is .jpg and is a validation image
